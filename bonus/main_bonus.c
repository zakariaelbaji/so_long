...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/21 14:51:02 by zel-baji          #+#    #+#             */
/*   Updated: 2025/03/18 17:16:39 by zel-baji         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	game.enemies = find_enemy(game.map);
	if (has_enemy_on_map(game.map))
		free_enemies_fail(&game);
