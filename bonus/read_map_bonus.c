...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/21 15:05:10 by zel-baji          #+#    #+#             */
/*   Updated: 2025/03/18 21:22:11 by zel-baji         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long_bonus.h"

static	char	*read_map_0(char *file, ssize_t read_bytes, size_t total_size,
		int fd)
{
	char	*buffer;
...
char	*read_map(char *file)
{
	...
	close(fd);
	buffer = read_map_0(file, read_bytes, total_size, fd);
